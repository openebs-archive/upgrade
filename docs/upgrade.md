...
These instructions will guide you through the process of upgrading cStor CSPC pools from `1.10.0` or later to a newer release up to `3.1.0`.
...
I0714 12:37:09.747331       1 cstor_cspc.go:65] Upgrading cspc-stripe to 3.1.0
...
I0714 12:40:31.701881       1 cstor_cspc.go:76] Successfully upgraded cspc-stripe to 3.1.0
```

## cStor CSI volumes

These instructions will guide you through the process of upgrading cStor CSI volumes from `1.10.0` or later to a newer release up to `3.1.0`.
...
I0714 14:00:53.309707       1 cstor_volume.go:67] Upgrading pvc-5fdce1bf-2cfc-4692-8353-8bc66deace49 to 3.1.0
...
I0714 14:03:26.046950       1 cstor_volume.go:78] Successfully upgraded pvc-5fdce1bf-2cfc-4692-8353-8bc66deace49 to 3.1.0
```

## jiva CSI volumes

These instructions will guide you through the process of upgrading jiva CSI volumes from `2.7.0` or later to a newer release up to `3.1.0`.
...
I0330 13:07:31.054955       1 jiva_volume.go:63] Upgrading JivaVolume pvc-9cebb2c3-b26e-4372-9e25-d1dc2d26c650 to 3.1.0
...
I0330 13:08:03.814190       1 jiva_volume.go:74] Successfully upgraded pvc-9cebb2c3-b26e-4372-9e25-d1dc2d26c650 to 3.1.0
```
