...
These instructions will guide you through the process of upgrading cStor CSPC pools from `1.10.0` or later to a newer release up to `2.11.0`.
 ...
 **Note:** If upgrading the control plane from 2.4.0 or the previous versions to the latest version please clean up the CSIDriver CR before applying the operator using the below command.
 ...
 For example if desired version is `2.11.0` the output should look like:
    
    $ kubectl -n openebs get pods -l openebs.io/version=2.11.0
...
I0714 12:37:09.747331       1 cstor_cspc.go:65] Upgrading cspc-stripe to 2.11.0
...
I0714 12:40:31.701881       1 cstor_cspc.go:76] Successfully upgraded cspc-stripe to 2.11.0
```

## cStor CSI volumes

These instructions will guide you through the process of upgrading cStor CSI volumes from `1.10.0` or later to a newer release up to `2.11.0`.
...
I0714 14:00:53.309707       1 cstor_volume.go:67] Upgrading pvc-5fdce1bf-2cfc-4692-8353-8bc66deace49 to 2.11.0
...
I0714 14:03:26.046950       1 cstor_volume.go:78] Successfully upgraded pvc-5fdce1bf-2cfc-4692-8353-8bc66deace49 to 2.11.0
```

## jiva CSI volumes

These instructions will guide you through the process of upgrading jiva CSI volumes from `2.7.0` or later to a newer release up to `2.11.0`.
